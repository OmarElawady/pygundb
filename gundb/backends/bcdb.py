...
try:
    ...
    bcdb = j.data.bcdb.new(name="testx")
...
todos* = (LO) !proj.todo
    ...
    class BCDB:
        ...
        def put(self, soul, key, value, state):
            ...
            valjson = json.loads(value)
            print("soul {} key {} value {} state {}".format(soul, key, value, state))
            try:
        ...
        def get(self, soul, key=None):
            ...
            # print(resm)
            print("soul {} key {} ".format(soul, key))
